...
public class MyHashMapUnitTest {
	...
	public void testResize(){
		...
		hashmap.add(s3);
		hashmap.resize();
		assertTrue("After resize, contains didn't find the elements!", hashmap.contains(s1));
		assertTrue("After resize, contains didn't find the elements!", hashmap.contains(s2));
		assertTrue("After resize, contains didn't find the elements!", hashmap.contains(s3));
	}
	...
	public void testWrongRemove() {
		hashmap.array[(hashmap.hashFunction(s1)+1) % hashmap.array.length] = s1;
		hashmap.remove(s1);
	}
	...
	public void testAddUntilFull() {
		...
		hashmap.add(s6);
		hashmap.add(s7);
		hashmap.add(s8); // it should fail here
	}
	...
	public void testAddRemoveContains() {
		hashmap.add(s1);
		hashmap.remove(s1);
		assertFalse("Contains has found an element which isn't there!", hashmap.contains(s1));
