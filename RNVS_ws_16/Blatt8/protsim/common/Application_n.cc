...
ModuleInterface(DummyApplication)
    // parameters:
    Parameter(applAddr, ParType_Numeric)
    // gates:
    Gate(in, GateDir_Input)
...
Register_ModuleInterface(DummyApplication)

//// Sample code:
// class DummyApplication : public cSimpleModule
// {
//     Module_Class_Members(DummyApplication,cSimpleModule,16384)
//     virtual void activity();
//     // Add you own member functions here!
// };
//
...
//
// void DummyApplication::activity()
// {
//     // Put code for simple module activity here!
// }
//

ModuleInterface(ExternalApplication)
    // parameters:
    Parameter(applAddr, ParType_Numeric)
    Parameter(ipAddr, ParType_Numeric)
    Parameter(port, ParType_Numeric)
    // gates:
    Gate(in, GateDir_Input)
    Gate(out, GateDir_Output)
EndInterface

Register_ModuleInterface(ExternalApplication)

//// Sample code:
// class ExternalApplication : public cSimpleModule
// {
//     Module_Class_Members(ExternalApplication,cSimpleModule,16384)
//     virtual void activity();
//     // Add you own member functions here!
// };
//
// Define_Module(ExternalApplication);
//
// void ExternalApplication::activity()
// {
//     // Put code for simple module activity here!
// }
//
