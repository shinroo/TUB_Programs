...
ModuleInterface(FakedRoutingDaemon)
    // parameters:
    Parameter(applAddr, ParType_Numeric)
    Parameter(rtableDumpFile, ParType_String)
    // gates:
    Gate(in, GateDir_Input)
    Gate(out, GateDir_Output)
EndInterface

Register_ModuleInterface(FakedRoutingDaemon)

//// Sample code:
// class FakedRoutingDaemon : public cSimpleModule
// {
//     Module_Class_Members(FakedRoutingDaemon,cSimpleModule,16384)
...
//
// void FakedRoutingDaemon::activity()
// {
