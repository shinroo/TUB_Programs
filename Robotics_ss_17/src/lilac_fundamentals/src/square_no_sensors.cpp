...
void move(double distance, double velocity, ros::ServiceClient *diffDrive){
	...
	// we decided to use constants for the velocity and time needed
	// instead of using the below formulae, but we have decided to leave
	// them here in case we need to generalise this method in future

        //double seconds = distance / velocity;
        //double angular_velocity = velocity / WHEEL_RAD;

	// calculated & adjusted values to move 1m
	double seconds = 11.11111;
