...
Register_ModuleInterface(PingPongAppl)

//// Sample code:
// class PingPongAppl : public cSimpleModule
// {
//     Module_Class_Members(PingPongAppl,cSimpleModule,16384)
