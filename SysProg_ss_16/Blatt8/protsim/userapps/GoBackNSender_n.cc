...
ModuleInterface(GoBackNSender)
    // parameters:
    Parameter(applAddr, ParType_Numeric)
    Parameter(destNode, ParType_Numeric)
    Parameter(destAppl, ParType_Numeric)
    Parameter(packetSize, ParType_Numeric)
    Parameter(timeout, ParType_Numeric)
    Parameter(interval, ParType_Numeric)
    Parameter(window, ParType_Numeric)
    // gates:
    Gate(in, GateDir_Input)
    Gate(out, GateDir_Output)
EndInterface

Register_ModuleInterface(GoBackNSender)

//// Sample code:
// class GoBackNSender : public cSimpleModule
// {
//     Module_Class_Members(GoBackNSender,cSimpleModule,16384)
