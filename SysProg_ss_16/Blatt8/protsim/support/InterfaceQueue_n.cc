...
ModuleInterface(InterfaceQueue)
    // parameters:
    Parameter(maxQueueLength, ParType_Numeric)
    Parameter(transientRemoval, ParType_Numeric)
    Parameter(batchLength, ParType_Numeric)
    // gates:
    Gate(in, GateDir_Input)
    Gate(out, GateDir_Output)
EndInterface

Register_ModuleInterface(InterfaceQueue)

//// Sample code:
// class InterfaceQueue : public cSimpleModule
// {
//     Module_Class_Members(InterfaceQueue,cSimpleModule,16384)
